...
* **（次回リリース）**
  ...
  * Indun Panel: **設定に「入場券」タブを足しました。** 入場券をどの順に使うかを▲▼で
    ...
    **レイド / チャレンジ・分裂特異点 / その他（ヴェルニース・テルハーシャ・嘆きの墓地・
  ...
  * Indun Panel: **どの入場券が使われるかが決まっていなかった**のを修正しました。
    ...
    振り分けを間違えることがなくなります。
  * Indun Panel: 券を選ぶ処理が**レイド・チャレンジ・分裂特異点・ヴェルニース・
    テルハーシャ・嘆きの墓地／共鳴の聖所で別々に書かれていた**のを 1 つにまとめました。
  ...
  * Indun Panel: **鍵の掛かった入場券があると、実際には入場できているのに
    ...
    しました。
  * Indun Panel: **テルハーシャの `BUYUSE` が、入場券を持っていても使わずに
