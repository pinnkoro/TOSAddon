...
g._nexus_addons_p = {{
    ...
    category = "battle",
    updated = g.VER_NEXT,
    updated_note_jp = "レイドなどバフの通知が集中する場所で重くなるのを直しました。非表示にしたバフの設定も保持されるようになりました",
    updated_note_en = "Fixed heavy lag where buff messages pile up (raids etc.). Hidden buff settings are now kept",
    data = {
        use = 0,
