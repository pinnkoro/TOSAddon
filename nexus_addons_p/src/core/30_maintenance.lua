...
g.backup_files = {"settings.json", "addons_menu.json", "aethergem_manager.json", "always_status.json",
                  ...
                  "guild_event_warp.json", "indun_list_viewer.json",
                  "indun_list_viewer.lua", "indun_panel.json",
                  ...
                  "mini_addons_log.dat", "monster_card_changer.json", "monster_kill_count.json", "muteki.json",
