...
![メシ屋（配食テーブル）の右上に追加された preset 1〜4 のボタン。選択中の preset 1 だけが赤くなっている](images/01-food-preset.png)
...
![Easy Buff Config の画面。preset 1〜4 が縦に並び、各プリセットに選択用のチェックと料理 6 種類のチェックが横並びで付く。最下部にバフ掛け直し確認と修理屋フレームの自動クローズのチェックがある](images/02-settings.png)
